...
//        dates.add(date);
        data = new FormData(department, eventDate, name, requesterID, Optional.of(phoneNum).toString(), Optional.of(faxNum).toString(), email, requestedOnDate,
        ...
        dataNoNumbers = new FormData(department, eventDate, name, requesterID, Optional.empty().toString(), Optional.empty().toString(), email, requestedOnDate,
                eventName, licensed, numAttendees, times, paymentAccountCode,
                invoiceRequested, eventDetails);
